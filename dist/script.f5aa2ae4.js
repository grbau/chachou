...
var letters = ["a", "n", "k", "p", "m", "h", "h", "t", "a", "b", "a", "p", "f", "q", "w", "v", "d", "t", "s", "c", "b", "e", "g", "v", "x", "c", "u", "e", "v", "r", "z", "c", "m", "w", "y", "z", "d", "n", "q", "n", "p", "a", "d", "p", "birdsTop", "e", "b", "i", "p", "k", "b", "e", "n", "birdsBottom", "j", "f", "n", "o", "d", "f", "l", "e", "m", "m", "c", "m", "d", "e", "s", "s", "g", "e", "o", "p", "l", "m", "x", "v", "i", "p", "i", "h", "a", "k", "g", "d", "r", "m"];
...
for (i = 0; i < letters.length; i++) {
  ...
  var _loop = function _loop(_i) {
    ...
    color.setAttribute("data-hex", '#' + colorList[_i] + '');
    color.style.background = '#' + colorList[_i] + '';
    ...
    color.addEventListener('click', function () {
      ...
      alert('Niel es-tu bien sur que ' + color.closest('.alphabet__letter').textContent + ' est la bonne lettre');
    });
  };
...
var words = document.querySelectorAll('.alphabet__letter');
words.forEach(function (word) {
  document.addEventListener('click', function (event) {
    var isClickInside = word.contains(event.target);
